...
MSGS = {
  ...
  btn_de_to_ru:         'Немецкий → Русский',
  btn_ru_to_de:         'Русский → Немецкий',
  ...
  upload_no_pairs:          'Не нашла пар слов. Проверь формат (немецкое слово[TAB]русское слово) и попробуй снова.',
  ...
  snoozed_list_header:  'Стоп-лист. Нажми на слово, чтобы вернуть его в очередь:',
  snoozed_list_empty:   'Стоп-лист пуст. Отлично! 🎉',
  ...
  edit_ask_more_de:  "Хочешь добавить ещё один немецкий вариант?",
  edit_new_de:       "Введи немецкое слово (с артиклем, если нужно):",
  edit_fix_ru: ->(current_ru) {
    "🇷🇺 Русский вариант:\n\n*#{current_ru}*\n\nЕсли здесь опечатка — введи исправленную версию.\nЕсли всё верно — нажми *Да*."
  },
  edit_ask_more_ru:  "Хочешь добавить ещё один вариант на русском?",
  edit_new_ru:       "Введи русский вариант:",
  edit_invalid:      "⚠️ Не удалось сохранить. Проверь слово и попробуй ещё раз.",
  edit_done: ->(de_list, ru_list) {
    de_str = de_list.join(', ')
    ru_str = ru_list.join(', ')
    "✅ Готово!\n\n🇩🇪 #{de_str}\n🇷🇺 #{ru_str}"
  },
